...
export default function A20220917() {
    const title = '2022/09/17 從現代到古典，吉他社';
    return (
        <article>
            <h1>{title}</h1>

            <p>今天有社團聯展，一百多個社團參與展覽，各式各樣的社團都有，有音樂的、運動的、表演的，尤其是慈善性質的佔最大宗，這點是最令我感到意外的。全部社團看下來，我有興趣的是管樂社、吉他社、古典吉他社。</p>
            ...
            <ol>
                <li>兩個是不同的樂器</li>
                <li>古典吉他的弦為尼龍線，有別於一般吉他的鋼弦</li>
                <li>古典吉他音色圓潤，適合演奏古典音樂</li>
                <li>可以把古典吉他當作是古典樂器</li>
            </ol>

            <p>我仔細想想，我平常喜歡聽的音樂就是緩慢型的，因此圓潤的音色搞不好更適合我。</p>
